...
export function TutorialAdminControls() {
  ...
  return (
    <div data-tour-id="admin-tutorial-toggle" className="hidden items-center gap-2 rounded-2xl border border-[#E8DDCC] bg-white px-2 py-2 shadow-sm dark:border-white/10 dark:bg-white/[0.06] xl:flex">
      <button
        type="button"
        onClick={toggle}
        disabled={busy}
        className="inline-flex min-h-9 items-center gap-2 rounded-full px-3 text-xs font-black text-[#1B1A17] transition hover:bg-[#F7F1E8] disabled:opacity-50 dark:text-[#FFF8EA] dark:hover:bg-white/10"
      ...
      <button
        ...
        className="min-h-9 rounded-full px-3 text-xs font-black text-[#B88A3D] transition hover:bg-[#F7F1E8] dark:text-[#D6AC63] dark:hover:bg-white/10"
      >
        Replay
      </button>
      <button
        ...
        className="min-h-9 rounded-full px-3 text-xs font-black text-[#6F675C] transition hover:bg-[#F7F1E8] dark:text-[#CDBCA8] dark:hover:bg-white/10"
      >
        Reset device
      </button>
      <button
