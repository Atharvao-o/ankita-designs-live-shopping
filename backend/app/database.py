...
def init_database() -> None:
    ...
    statements = [
        ...
        "ALTER TABLE vendors ADD COLUMN IF NOT EXISTS correction_reason TEXT",
        "ALTER TABLE vendors ADD COLUMN IF NOT EXISTS correction_requested_at TIMESTAMP",
        "ALTER TABLE vendors ADD COLUMN IF NOT EXISTS resubmitted_at TIMESTAMP",
        "ALTER TABLE vendors ADD COLUMN IF NOT EXISTS application_revision INTEGER DEFAULT 1 NOT NULL",
