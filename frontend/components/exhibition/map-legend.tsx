...
export function MapLegend({ stalls }: { stalls: ExhibitionStall[] }) {
  ...
  return (
    <div className="absolute left-3 top-24 z-20 hidden w-[min(82vw,260px)] rounded-[26px] border border-[#E4C88C]/80 bg-[#FFFDF8]/92 p-4 shadow-[0_18px_60px_rgba(80,52,20,0.14)] backdrop-blur-xl sm:left-6 sm:top-24 sm:block">
...
function LegendRow({ color, label, value }: { color: string; label: string; value: number }) {
  return (
    <div className="flex items-center justify-between gap-3 rounded-2xl bg-white/84 px-3 py-2 shadow-[inset_0_0_0_1px_rgba(217,190,131,0.22)]">
